  ...
  return (
    <>
      ...
      <div className="h-[calc(100vh-6rem)] flex flex-col p-4 lg:p-6 overflow-hidden bg-[#0F1419]">
        <Tabs defaultValue="green" className="w-full h-full flex flex-col">
          <TabsList className="grid w-full max-w-md grid-cols-2 bg-slate-800/50 p-1 mb-4 rounded-xl mx-auto border border-custom">
            <TabsTrigger 
                value="green" 
